...
class _ClocksDetailState extends State<ClocksDetail> {
  ...
  Widget clocksDetailBody(){
    ...
    if(widget.intern.schedules[today]['clock_in'] != null && widget.intern.schedules[today]['clock_in'] != ''){
      scheduleClockIn = '${widget.intern.schedules[today]['clock_in'].toDate()
          .hour.toString().padLeft(2, '0')}:${widget.intern.schedules[today]['clock_in'].toDate().minute.toString().padLeft(2, '0')}' ?? '-';
    }

    if(widget.intern.schedules[today]['clock_out'] != null && widget.intern.schedules[today]['clock_out'] != ''){
      scheduleClockOut = '${widget.intern.schedules[today]['clock_out'].toDate()
          .hour.toString().padLeft(2, '0')}:${widget.intern.schedules[today]['clock_out'].toDate().minute.toString().padLeft(2, '0')}' ?? '-';
    }

    String clockedIn = '-';
    String clockedOut = '-';

    if(widget.intern.clocks[today]['clock_in'] != null && widget.intern.clocks[today]['clock_in'] != ''){
      clockedIn = DateFormat.yMMMd().add_jm().format(widget.intern.clocks[today]['clock_in'].toDate());
    }

    if(widget.intern.clocks[today]['clock_out'] != null && widget.intern.clocks[today]['clock_out'] != ''){
      clockedOut = DateFormat.yMMMd().add_jm().format(widget.intern.clocks[today]['clock_out'].toDate());
    }
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text('${AppLocalizations.of(context).translate('today')}\'s ${AppLocalizations.of(context).translate('work_schedule')}', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
                    SizedBox(height: 25),
                    Text('$scheduleClockIn to $scheduleClockOut', style: TextStyle(fontSize: 16, color: Colors.grey[500])),
                    SizedBox(height: 50),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('$clockedIn', style: TextStyle(fontSize: 16, color: Colors.green[500])),
                      ],
                    ),
                    SizedBox(height: 50),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('$clockedOut', style: TextStyle(fontSize: 16, color: Colors.green[500])),
                      ],
                    ),
                    SizedBox(height: 50),
                    ...
                    SizedBox(height: 25),
                    Text(widget.intern.address != null && widget.intern.address != '' ? widget.intern.address : AppLocalizations.of(context).translate('no_address'), style: TextStyle(fontSize: 16, color: Colors.grey[500])),
                    SizedBox(height: 25),
                  ]
                )
              ]
